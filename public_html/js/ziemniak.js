...
//        CFG.Draw.text(CFG.beforeTime, 10, 30, 20,"0");
    ...
    drawBackground: function(){
        CFG.ctx.drawImage(CFG.sprite, 0, 0, 512, 768, 0, 0, 320, 480);
    },
...
CFG.View.menu.paint = function(){
    CFG.ctx.drawImage(CFG.sprite, 512, 0, 320, 480, 0, 0, 320, 480);
    if (CFG.isLoggedIn){
...
//            if (this.isSpraying){
                CFG.ctx.drawImage(CFG.sprite, 513, 481, 100, 100, this.x, this.y-90, 50, 68);
//            } else {
